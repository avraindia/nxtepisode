                ...
                <div class="product-details-text">
                    ...
                    <div class="add-to-cart-add-to-wishlist-btn">
                        <div class="row g-md-3">
                            <form id="submitForm" action="{{ route('exchange_checkout') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">
                                    <div class="add-to-cart-btn">
                                        <a href="javascript:void(0);" class="buy_now_btn">Buy Now</a>
                                    </div>
                                </div>
...
$(document).on('click', '.buy_now_btn', function(e) {
    var size_id = $('.product_size_id').val();
    if(size_id == ""){
        Swal.fire({
            icon: 'error',
