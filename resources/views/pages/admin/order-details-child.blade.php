        ...
        @foreach($status_details as $status)
            ...
            <li class="list-inline-item event-list">
                <div class="px-4">
                    ...
                    <h5 class="font-size-16">Order Placed</h5>
                </div>
            ...
            <li class="list-inline-item event-list">
                <div class="px-4">
                    <div class="event-date bg-soft-success text-success">{{$status->order_status_time}}</div>
                    <h5 class="font-size-16">Order Packed</h5>
                </div>
            </li>
            ...
            <li class="list-inline-item event-list">
                <div class="px-4">
                    <div class="event-date bg-soft-success text-success">{{$status->order_status_time}}</div>
                    <h5 class="font-size-16">Order Dispatched</h5>
                </div>
                @if (!in_array('On the way', $all_status))
                @if (!in_array('Cancelled', $all_status))
                <button type="button" class="btn-blue on_the_way_button status-btn">Mark order as Out for delivery</button>
                @endif
                @endif
            </li>
            @endif
            ...
            <!-- ORDER On the way CHECK START -->
            @if ($status->status_name == 'On the way')
            <li class="list-inline-item event-list">
                <div class="px-4">
                    <div class="event-date bg-soft-success text-success">{{$status->order_status_time}}</div>
                    <h5 class="font-size-16">Order out for delivery</h5>
                </div>
                @if (!in_array('Delivered', $all_status))
                @if (!in_array('Cancelled', $all_status))
                <button type="button" class="btn-blue order_delivered_button status-btn">Mark order as Deliverd</button>
                @endif
                @endif
            </li>
            @endif
            <!-- ORDER On the way CHECK END -->

            @if ($status->status_name == 'Delivered')
            <li class="list-inline-item event-list">
                <div class="px-4">
                    <div class="event-date bg-soft-success text-success">{{$status->order_status_time}}</div>
                    <h5 class="font-size-16">Order Delivered</h5>
                </div>
            </li>
            @endif
            ...
            <li class="list-inline-item event-list">
                <div class="px-4">
                    <div class="event-date bg-soft-danger text-danger">{{$status->order_status_time}}</div>
                    <h5 class="font-size-16">Order Cancelled</h5>
                </div>
            </li>
            @endif
        @endforeach
