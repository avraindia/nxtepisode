    ...
    <div class="card">
        <div class="card-body">
            <div class="align-items-center d-md-flex justify-content-between mb-4">
                <div class="">
                    <h1 class="card-title m-md-0 mb-3"> Edit Public Opinion</h1>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control public_opinion" rows="4" name="public_opinion" required>{{$opinion_item->public_opinion}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control opinion_order" placeholder="" value="{{$opinion_item->opinion_order}}" name="opinion_order" required>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <img src="{{$opinion_item->public_opinion_image_link}}" style="width: 200px;">
                                    <input type="hidden" name="opinion_id" value="{{$opinion_item->id}}">
                                </div>
                            </div>
                        </div>
                    </div>
