    ...
    <div style="width:800px; margin:auto; background: #f0f0f0; padding: 15px;">
        <table style="width:100%; background: #fff; padding: 15px;">
            <tr>
                ...
                <td>
                    <p style="font-size:15px; color:#000; font-weight: 600; text-align: right;">ORDER No. #
                    {{$data['order_details']['order_number']}}</p>
            ...
            <?php
            $refund_msg = "";
            if($data['payment_refund'] == 'yes'){
                $refund_msg = "  Your order amount will be refunded soon.";
            }
            ?>
            <tr>
                <td colspan="2">
                    ...
                    <p style="color: #32353a; font-size: 16px; line-height: 27px;">Your cancellation request for #{{$data['order_details']['order_number']}} has been successfully processed.{{$refund_msg}} Please let us know the reason for the cancelation to
